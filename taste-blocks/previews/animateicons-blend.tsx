...
import { BlendIcon } from "@/registry/sources/animateicons/components/animateicons-blend/blend-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <BlendIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
