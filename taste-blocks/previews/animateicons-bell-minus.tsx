...
import { BellMinusIcon } from "@/registry/sources/animateicons/components/animateicons-bell-minus/bell-minus-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Bell Minus Icon"
      ...
      >
        <BellMinusIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
