...
import { PoundSterlingIcon } from "@/registry/sources/animateicons/components/animateicons-pound-sterling/pound-sterling-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Pound Sterling Icon"
      ...
      >
        <PoundSterlingIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
