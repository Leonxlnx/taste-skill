...
import { ChevronsDownIcon } from "@/registry/sources/animateicons/components/animateicons-chevrons-down/chevrons-down-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chevrons Down Icon"
      ...
      >
        <ChevronsDownIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
