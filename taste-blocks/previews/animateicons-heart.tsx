...
import { HeartIcon } from "@/registry/sources/animateicons/components/animateicons-heart/heart-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <HeartIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
