...
import { RocketIcon } from "@/registry/sources/animateicons/components/animateicons-rocket/rocket-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Rocket Icon"
      ...
      >
        <RocketIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
