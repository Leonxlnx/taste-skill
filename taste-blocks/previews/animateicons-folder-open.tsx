...
import { FolderOpenIcon } from "@/registry/sources/animateicons/components/animateicons-folder-open/folder-open-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Folder Open Icon"
      ...
      >
        <FolderOpenIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
