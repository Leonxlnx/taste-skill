...
import { BellIcon } from "@/registry/sources/animateicons/components/animateicons-bell/bell-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <BellIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
