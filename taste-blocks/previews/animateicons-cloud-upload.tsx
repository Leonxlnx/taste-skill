...
import { CloudUploadIcon } from "@/registry/sources/animateicons/components/animateicons-cloud-upload/cloud-upload-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Cloud Upload Icon"
      ...
      >
        <CloudUploadIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
