...
import { HeadphonesIcon } from "@/registry/sources/animateicons/components/animateicons-headphones/headphones-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Headphones Icon"
      ...
      >
        <HeadphonesIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
