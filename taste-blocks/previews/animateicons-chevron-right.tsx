...
import { ChevronRightIcon } from "@/registry/sources/animateicons/components/animateicons-chevron-right/chevron-right-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chevron Right Icon"
      ...
      >
        <ChevronRightIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
