...
import { CircleCheckIcon } from "@/registry/sources/animateicons/components/animateicons-circle-check/circle-check-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Circle Check Icon"
      ...
      >
        <CircleCheckIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
