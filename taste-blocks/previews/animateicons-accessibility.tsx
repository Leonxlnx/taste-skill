...
import { AccessibilityIcon } from "@/registry/sources/animateicons/components/animateicons-accessibility/accessibility-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Accessibility Icon"
      ...
      >
        <AccessibilityIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
