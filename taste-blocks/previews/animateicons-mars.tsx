...
import { MarsIcon } from "@/registry/sources/animateicons/components/animateicons-mars/mars-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <MarsIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
