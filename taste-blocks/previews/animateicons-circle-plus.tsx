...
import { CirclePlusIcon } from "@/registry/sources/animateicons/components/animateicons-circle-plus/circle-plus-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Circle Plus Icon"
      ...
      >
        <CirclePlusIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
