...
import { MoveDiagonalIcon } from "@/registry/sources/animateicons/components/animateicons-move-diagonal/move-diagonal-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Move Diagonal Icon"
      ...
      >
        <MoveDiagonalIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
