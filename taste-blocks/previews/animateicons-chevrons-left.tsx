...
import { ChevronsLeftIcon } from "@/registry/sources/animateicons/components/animateicons-chevrons-left/chevrons-left-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chevrons Left Icon"
      ...
      >
        <ChevronsLeftIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
