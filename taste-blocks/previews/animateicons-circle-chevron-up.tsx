...
import { CircleChevronUpIcon } from "@/registry/sources/animateicons/components/animateicons-circle-chevron-up/circle-chevron-up-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Circle Chevron Up Icon"
      ...
      >
        <CircleChevronUpIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
