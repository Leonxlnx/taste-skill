...
import { LoginIcon } from "@/registry/sources/animateicons/components/animateicons-login/login-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <LoginIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
