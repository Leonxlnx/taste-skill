...
import { BitcoinIcon } from "@/registry/sources/animateicons/components/animateicons-bitcoin/bitcoin-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Bitcoin Icon"
      ...
      >
        <BitcoinIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
