...
import { CircleCheckBigIcon } from "@/registry/sources/animateicons/components/animateicons-circle-check-big/circle-check-big-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Circle Check Big Icon"
      ...
      >
        <CircleCheckBigIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
