...
import { AudioLinesIcon } from "@/registry/sources/animateicons/components/animateicons-audio-lines/audio-lines-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Audio Lines Icon"
      ...
      >
        <AudioLinesIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
