...
import { PhoneMissedIcon } from "@/registry/sources/animateicons/components/animateicons-phone-missed/phone-missed-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Phone Missed Icon"
      ...
      >
        <PhoneMissedIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
