...
import { SaudiRiyalIcon } from "@/registry/sources/animateicons/components/animateicons-saudi-riyal/saudi-riyal-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Saudi Riyal Icon"
      ...
      >
        <SaudiRiyalIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
