...
import { ContactIcon } from "@/registry/sources/animateicons/components/animateicons-contact/contact-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Contact Icon"
      ...
      >
        <ContactIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
