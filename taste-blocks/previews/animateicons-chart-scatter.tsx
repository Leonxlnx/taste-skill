...
import { ChartScatterIcon } from "@/registry/sources/animateicons/components/animateicons-chart-scatter/chart-scatter-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chart Scatter Icon"
      ...
      >
        <ChartScatterIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
