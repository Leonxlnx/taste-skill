...
import { CoffeeIcon } from "@/registry/sources/animateicons/components/animateicons-coffee/coffee-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Coffee Icon"
      ...
      >
        <CoffeeIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
