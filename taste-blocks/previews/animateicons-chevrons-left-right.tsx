...
import { ChevronsLeftRightIcon } from "@/registry/sources/animateicons/components/animateicons-chevrons-left-right/chevrons-left-right-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chevrons Left Right Icon"
      ...
      >
        <ChevronsLeftRightIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
