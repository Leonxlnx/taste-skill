...
import { DashboardIcon } from "@/registry/sources/animateicons/components/animateicons-layout-dashboard-icon/dashboard-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Layout Dashboard Icon"
      ...
      >
        <DashboardIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
