...
import { UnlinkIcon } from "@/registry/sources/animateicons/components/animateicons-unlink/unlink-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Unlink Icon"
      ...
      >
        <UnlinkIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
