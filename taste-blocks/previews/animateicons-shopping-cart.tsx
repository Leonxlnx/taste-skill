...
import { ShoppingCartIcon } from "@/registry/sources/animateicons/components/animateicons-shopping-cart/shopping-cart-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Shopping Cart Icon"
      ...
      >
        <ShoppingCartIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
