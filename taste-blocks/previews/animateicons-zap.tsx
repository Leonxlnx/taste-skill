...
import { ZapIcon } from "@/registry/sources/animateicons/components/animateicons-zap/zap-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <ZapIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
