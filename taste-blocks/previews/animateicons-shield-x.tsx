...
import { ShieldXIcon } from "@/registry/sources/animateicons/components/animateicons-shield-x/shield-x-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Shield X Icon"
      ...
      >
        <ShieldXIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
