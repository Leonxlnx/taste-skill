...
import { PhoneIncomingIcon } from "@/registry/sources/animateicons/components/animateicons-phone-incoming/phone-incoming-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Phone Incoming Icon"
      ...
      >
        <PhoneIncomingIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
