...
import { CircleChevronDownIcon } from "@/registry/sources/animateicons/components/animateicons-circle-chevron-down/circle-chevron-down-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Circle Chevron Down Icon"
      ...
      >
        <CircleChevronDownIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
