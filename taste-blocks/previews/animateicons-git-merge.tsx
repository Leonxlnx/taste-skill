...
import { GitMergeIcon } from "@/registry/sources/animateicons/components/animateicons-git-merge/git-merge-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Git Merge Icon"
      ...
      >
        <GitMergeIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
