...
import { CornerDownRightIcon } from "@/registry/sources/animateicons/components/animateicons-corner-down-right/corner-down-right-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Corner Down Right Icon"
      ...
      >
        <CornerDownRightIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
