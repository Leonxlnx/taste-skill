...
import { ChartNetworkIcon } from "@/registry/sources/animateicons/components/animateicons-chart-network/chart-network-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chart Network Icon"
      ...
      >
        <ChartNetworkIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
