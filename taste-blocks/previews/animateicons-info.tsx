...
import { InfoIcon } from "@/registry/sources/animateicons/components/animateicons-info/info-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <InfoIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
