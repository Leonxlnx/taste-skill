...
import { BoneIcon, type BoneIconHandle } from "@/registry/sources/lucide-animated/components/lucide-animated-bone-icon/bone";

export default function Preview() {
  const icon = useRef<BoneIconHandle>(null);
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <BoneIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
