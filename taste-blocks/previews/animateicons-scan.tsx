...
import { ScanIcon } from "@/registry/sources/animateicons/components/animateicons-scan/scan-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <ScanIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
