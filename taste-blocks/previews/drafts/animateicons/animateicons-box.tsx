...
import { BoxIcon } from "@/registry/sources/animateicons/components/animateicons-box/box-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <BoxIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
