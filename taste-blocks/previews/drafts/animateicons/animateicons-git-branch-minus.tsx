...
import { GitBranchMinusIcon } from "@/registry/sources/animateicons/components/animateicons-git-branch-minus/git-branch-minus-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Git Branch Minus Icon"
      ...
      >
        <GitBranchMinusIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
