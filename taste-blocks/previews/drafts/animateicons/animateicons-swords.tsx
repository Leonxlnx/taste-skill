...
import { SwordsIcon } from "@/registry/sources/animateicons/components/animateicons-swords/swords-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Swords Icon"
      ...
      >
        <SwordsIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
