...
import { BadgeCentIcon } from "@/registry/sources/animateicons/components/animateicons-badge-cent/badge-cent-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Badge Cent Icon"
      ...
      >
        <BadgeCentIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
