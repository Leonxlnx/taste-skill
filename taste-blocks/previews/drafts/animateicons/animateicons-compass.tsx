...
import { CompassIcon } from "@/registry/sources/animateicons/components/animateicons-compass/compass-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Compass Icon"
      ...
      >
        <CompassIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
