...
import { TelescopeIcon } from "@/registry/sources/animateicons/components/animateicons-telescope/telescope-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Telescope Icon"
      ...
      >
        <TelescopeIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
