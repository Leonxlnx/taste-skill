...
import { TrashIcon } from "@/registry/sources/animateicons/components/animateicons-trash/trash-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <TrashIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
