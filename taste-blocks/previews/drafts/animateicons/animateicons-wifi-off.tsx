...
import { WifiOffIcon } from "@/registry/sources/animateicons/components/animateicons-wifi-off/wifi-off-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Wifi Off Icon"
      ...
      >
        <WifiOffIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
