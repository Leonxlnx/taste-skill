...
import { BookOpenTextIcon } from "@/registry/sources/animateicons/components/animateicons-book-open-text/book-open-text-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Book Open Text Icon"
      ...
      >
        <BookOpenTextIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
