...
import { AnnoyedIcon } from "@/registry/sources/animateicons/components/animateicons-annoyed/annoyed-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Annoyed Icon"
      ...
      >
        <AnnoyedIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
