...
import { UserLockIcon } from "@/registry/sources/animateicons/components/animateicons-user-lock/user-lock-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate User Lock Icon"
      ...
      >
        <UserLockIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
