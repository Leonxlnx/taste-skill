...
import { ChevronLeftIcon } from "@/registry/sources/animateicons/components/animateicons-chevron-left/chevron-left-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chevron Left Icon"
      ...
      >
        <ChevronLeftIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
