...
import { GitCompareIcon } from "@/registry/sources/animateicons/components/animateicons-git-compare/git-compare-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Git Compare Icon"
      ...
      >
        <GitCompareIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
