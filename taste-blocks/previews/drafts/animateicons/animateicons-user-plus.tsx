...
import { UserPlusIcon } from "@/registry/sources/animateicons/components/animateicons-user-plus/user-plus-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate User Plus Icon"
      ...
      >
        <UserPlusIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
