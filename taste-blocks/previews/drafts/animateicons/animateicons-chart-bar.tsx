...
import { ChartBarIcon } from "@/registry/sources/animateicons/components/animateicons-chart-bar/chart-bar-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chart Bar Icon"
      ...
      >
        <ChartBarIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
