...
import { UserPenIcon } from "@/registry/sources/animateicons/components/animateicons-user-pen/user-pen-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate User Pen Icon"
      ...
      >
        <UserPenIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
