...
import { KeySquareIcon } from "@/registry/sources/animateicons/components/animateicons-key-square/key-square-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Key Square Icon"
      ...
      >
        <KeySquareIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
