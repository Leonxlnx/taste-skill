...
import { ChevronDownIcon } from "@/registry/sources/animateicons/components/animateicons-chevron-down/chevron-down-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chevron Down Icon"
      ...
      >
        <ChevronDownIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
