...
import { ChartNoAxesCombinedIcon } from "@/registry/sources/animateicons/components/animateicons-chart-no-axes-combined/chart-no-axes-combined-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chart No Axes Combined Icon"
      ...
      >
        <ChartNoAxesCombinedIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
