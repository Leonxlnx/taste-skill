...
import { LogoutIcon } from "@/registry/sources/animateicons/components/animateicons-logout/logout-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Logout Icon"
      ...
      >
        <LogoutIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
