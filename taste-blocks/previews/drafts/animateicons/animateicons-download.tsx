...
import { DownloadIcon } from "@/registry/sources/animateicons/components/animateicons-download/download-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Download Icon"
      ...
      >
        <DownloadIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
