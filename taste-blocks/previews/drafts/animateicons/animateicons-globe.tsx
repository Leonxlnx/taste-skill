...
import { GlobeIcon } from "@/registry/sources/animateicons/components/animateicons-globe/globe-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <GlobeIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
