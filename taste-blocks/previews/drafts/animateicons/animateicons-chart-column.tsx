...
import { ChartColumnIcon } from "@/registry/sources/animateicons/components/animateicons-chart-column/chart-column-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chart Column Icon"
      ...
      >
        <ChartColumnIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
