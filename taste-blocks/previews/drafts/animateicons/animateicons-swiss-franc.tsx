...
import { SwissFrancIcon } from "@/registry/sources/animateicons/components/animateicons-swiss-franc/swiss-franc-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Swiss Franc Icon"
      ...
      >
        <SwissFrancIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
