...
import { ThumbsUpIcon } from "@/registry/sources/animateicons/components/animateicons-thumbs-up/thumbs-up-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Thumbs Up Icon"
      ...
      >
        <ThumbsUpIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
