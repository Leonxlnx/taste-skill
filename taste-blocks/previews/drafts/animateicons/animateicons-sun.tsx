...
import { SunIcon } from "@/registry/sources/animateicons/components/animateicons-sun/sun-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <SunIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
