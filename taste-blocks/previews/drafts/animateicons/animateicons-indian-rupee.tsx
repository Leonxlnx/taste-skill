...
import { IndianRupeeIcon } from "@/registry/sources/animateicons/components/animateicons-indian-rupee/indian-rupee-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Indian Rupee Icon"
      ...
      >
        <IndianRupeeIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
