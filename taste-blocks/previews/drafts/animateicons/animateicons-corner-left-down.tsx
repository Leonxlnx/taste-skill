...
import { CornerLeftDownIcon } from "@/registry/sources/animateicons/components/animateicons-corner-left-down/corner-left-down-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Corner Left Down Icon"
      ...
      >
        <CornerLeftDownIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
