...
import { UserXIcon } from "@/registry/sources/animateicons/components/animateicons-user-x/user-x-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate User X Icon"
      ...
      >
        <UserXIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
