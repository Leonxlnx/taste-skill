...
import { BookmarkXIcon } from "@/registry/sources/animateicons/components/animateicons-bookmark-x/bookmark-x-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Bookmark X Icon"
      ...
      >
        <BookmarkXIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
