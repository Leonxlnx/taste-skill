...
import { FlameIcon } from "@/registry/sources/animateicons/components/animateicons-flame/flame-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <FlameIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
