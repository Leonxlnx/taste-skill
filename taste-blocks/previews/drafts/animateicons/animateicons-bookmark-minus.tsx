...
import { BookmarkMinusIcon } from "@/registry/sources/animateicons/components/animateicons-bookmark-minus/bookmark-minus-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Bookmark Minus Icon"
      ...
      >
        <BookmarkMinusIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
