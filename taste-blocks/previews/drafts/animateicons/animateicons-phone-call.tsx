...
import { PhoneCallIcon } from "@/registry/sources/animateicons/components/animateicons-phone-call/phone-call-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Phone Call Icon"
      ...
      >
        <PhoneCallIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
