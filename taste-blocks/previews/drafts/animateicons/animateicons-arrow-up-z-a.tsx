...
import { ArrowUpZAIcon } from "@/registry/sources/animateicons/components/animateicons-arrow-up-z-a/arrow-up-z-a-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Arrow Up Z A Icon"
      ...
      >
        <ArrowUpZAIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
