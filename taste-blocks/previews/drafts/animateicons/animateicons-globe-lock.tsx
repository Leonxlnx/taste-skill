...
import { GlobeLockIcon } from "@/registry/sources/animateicons/components/animateicons-globe-lock/globe-lock-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Globe Lock Icon"
      ...
      >
        <GlobeLockIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
