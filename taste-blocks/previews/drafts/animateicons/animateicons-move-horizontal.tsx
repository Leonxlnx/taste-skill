...
import { MoveHorizontalIcon } from "@/registry/sources/animateicons/components/animateicons-move-horizontal/move-horizontal-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Move Horizontal Icon"
      ...
      >
        <MoveHorizontalIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
