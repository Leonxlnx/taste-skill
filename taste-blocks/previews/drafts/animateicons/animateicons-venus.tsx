...
import { VenusIcon } from "@/registry/sources/animateicons/components/animateicons-venus/venus-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <VenusIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
