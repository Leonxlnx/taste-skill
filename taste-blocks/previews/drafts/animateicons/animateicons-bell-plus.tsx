...
import { BellPlusIcon } from "@/registry/sources/animateicons/components/animateicons-bell-plus/bell-plus-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Bell Plus Icon"
      ...
      >
        <BellPlusIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
