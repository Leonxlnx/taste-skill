...
import { BookmarkCheckIcon } from "@/registry/sources/animateicons/components/animateicons-bookmark-check/bookmark-check-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Bookmark Check Icon"
      ...
      >
        <BookmarkCheckIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
