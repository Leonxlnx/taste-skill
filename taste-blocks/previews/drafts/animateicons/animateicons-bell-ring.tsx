...
import { BellRingIcon } from "@/registry/sources/animateicons/components/animateicons-bell-ring/bell-ring-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Bell Ring Icon"
      ...
      >
        <BellRingIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
