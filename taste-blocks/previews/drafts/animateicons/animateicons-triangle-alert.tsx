...
import { TriangleAlertIcon } from "@/registry/sources/animateicons/components/animateicons-triangle-alert/triangle-alert-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Triangle Alert Icon"
      ...
      >
        <TriangleAlertIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
