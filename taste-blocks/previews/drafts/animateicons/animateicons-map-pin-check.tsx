...
import { MapPinCheckIcon } from "@/registry/sources/animateicons/components/animateicons-map-pin-check/map-pin-check-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Map Pin Check Icon"
      ...
      >
        <MapPinCheckIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
