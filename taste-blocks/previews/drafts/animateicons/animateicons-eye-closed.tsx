...
import { EyeClosedIcon } from "@/registry/sources/animateicons/components/animateicons-eye-closed/eye-closed-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Eye Closed Icon"
      ...
      >
        <EyeClosedIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
