...
import { MoveDiagonal2Icon } from "@/registry/sources/animateicons/components/animateicons-move-diagonal-2/move-diagonal-2-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Move Diagonal 2 Icon"
      ...
      >
        <MoveDiagonal2Icon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
