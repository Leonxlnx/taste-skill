...
import { ChevronsRightIcon } from "@/registry/sources/animateicons/components/animateicons-chevrons-right/chevrons-right-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chevrons Right Icon"
      ...
      >
        <ChevronsRightIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
