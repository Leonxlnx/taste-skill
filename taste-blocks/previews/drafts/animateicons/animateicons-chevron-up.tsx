...
import { ChevronUpIcon } from "@/registry/sources/animateicons/components/animateicons-chevron-up/chevron-up-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chevron Up Icon"
      ...
      >
        <ChevronUpIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
