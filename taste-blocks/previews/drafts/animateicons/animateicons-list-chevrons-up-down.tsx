...
import { ListChevronsUpDownIcon } from "@/registry/sources/animateicons/components/animateicons-list-chevrons-up-down/list-chevrons-up-down-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate List Chevrons Up Down Icon"
      ...
      >
        <ListChevronsUpDownIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
