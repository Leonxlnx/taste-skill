...
import { ExternalLinkIcon } from "@/registry/sources/animateicons/components/animateicons-external-link/external-link-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate External Link Icon"
      ...
      >
        <ExternalLinkIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
