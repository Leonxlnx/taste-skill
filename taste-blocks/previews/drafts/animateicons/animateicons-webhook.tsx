...
import { WebhookIcon } from "@/registry/sources/animateicons/components/animateicons-webhook/webhook-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Webhook Icon"
      ...
      >
        <WebhookIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
