...
import { YenYuanIcon } from "@/registry/sources/animateicons/components/animateicons-yen-yuan/yen-yuan-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Yen Yuan Icon"
      ...
      >
        <YenYuanIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
