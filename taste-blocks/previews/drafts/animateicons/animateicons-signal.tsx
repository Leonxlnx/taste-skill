...
import { SignalIcon } from "@/registry/sources/animateicons/components/animateicons-signal/signal-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Signal Icon"
      ...
      >
        <SignalIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
