...
import { RussianRubleIcon } from "@/registry/sources/animateicons/components/animateicons-russian-ruble/russian-ruble-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Russian Ruble Icon"
      ...
      >
        <RussianRubleIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
