...
import { ShoppingBagIcon } from "@/registry/sources/animateicons/components/animateicons-shopping-bag/shopping-bag-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Shopping Bag Icon"
      ...
      >
        <ShoppingBagIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
