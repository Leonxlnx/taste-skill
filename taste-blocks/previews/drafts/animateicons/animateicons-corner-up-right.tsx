...
import { CornerUpRightIcon } from "@/registry/sources/animateicons/components/animateicons-corner-up-right/corner-up-right-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Corner Up Right Icon"
      ...
      >
        <CornerUpRightIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
