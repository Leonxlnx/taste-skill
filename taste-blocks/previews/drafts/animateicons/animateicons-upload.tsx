...
import { UploadIcon } from "@/registry/sources/animateicons/components/animateicons-upload/upload-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Upload Icon"
      ...
      >
        <UploadIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
