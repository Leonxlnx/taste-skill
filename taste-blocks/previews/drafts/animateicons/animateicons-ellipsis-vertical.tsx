...
import { EllipsisVerticalIcon } from "@/registry/sources/animateicons/components/animateicons-ellipsis-vertical/ellipsis-vertical-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Ellipsis Vertical Icon"
      ...
      >
        <EllipsisVerticalIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
