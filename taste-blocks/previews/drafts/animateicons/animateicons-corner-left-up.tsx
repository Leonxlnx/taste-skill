...
import { CornerLeftUpIcon } from "@/registry/sources/animateicons/components/animateicons-corner-left-up/corner-left-up-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Corner Left Up Icon"
      ...
      >
        <CornerLeftUpIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
