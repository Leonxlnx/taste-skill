...
import { BatteryIcon } from "@/registry/sources/animateicons/components/animateicons-battery/battery-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Battery Icon"
      ...
      >
        <BatteryIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
