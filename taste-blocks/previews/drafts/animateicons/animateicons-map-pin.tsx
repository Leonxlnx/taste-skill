...
import { MapPinIcon } from "@/registry/sources/animateicons/components/animateicons-map-pin/map-pin-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Map Pin Icon"
      ...
      >
        <MapPinIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
