...
import { WifiSyncIcon } from "@/registry/sources/animateicons/components/animateicons-wifi-sync/wifi-sync-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Wifi Sync Icon"
      ...
      >
        <WifiSyncIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
