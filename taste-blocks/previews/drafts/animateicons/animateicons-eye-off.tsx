...
import { EyeOffIcon } from "@/registry/sources/animateicons/components/animateicons-eye-off/eye-off-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Eye Off Icon"
      ...
      >
        <EyeOffIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
