...
import { GamepadIcon } from "@/registry/sources/animateicons/components/animateicons-gamepad/gamepad-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Gamepad Icon"
      ...
      >
        <GamepadIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
