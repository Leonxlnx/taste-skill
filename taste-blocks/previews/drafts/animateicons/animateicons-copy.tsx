...
import { CopyIcon } from "@/registry/sources/animateicons/components/animateicons-copy/copy-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <CopyIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
