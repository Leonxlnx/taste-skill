...
import { MapPinCheckInsideIcon } from "@/registry/sources/animateicons/components/animateicons-map-pin-check-inside/map-pin-check-inside-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Map Pin Check Inside Icon"
      ...
      >
        <MapPinCheckInsideIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
