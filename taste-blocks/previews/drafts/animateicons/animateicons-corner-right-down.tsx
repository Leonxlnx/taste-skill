...
import { CornerRightDownIcon } from "@/registry/sources/animateicons/components/animateicons-corner-right-down/corner-right-down-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Corner Right Down Icon"
      ...
      >
        <CornerRightDownIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
