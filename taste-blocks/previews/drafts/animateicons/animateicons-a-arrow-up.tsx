...
import { AArrowUpIcon } from "@/registry/sources/animateicons/components/animateicons-a-arrow-up/a-arrow-up-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate A Arrow Up Icon"
      ...
      >
        <AArrowUpIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
