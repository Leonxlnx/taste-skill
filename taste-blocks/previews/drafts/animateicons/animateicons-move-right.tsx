...
import { MoveRightIcon } from "@/registry/sources/animateicons/components/animateicons-move-right/move-right-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Move Right Icon"
      ...
      >
        <MoveRightIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
