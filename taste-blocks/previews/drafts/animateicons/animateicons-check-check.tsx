...
import { CheckCheckIcon } from "@/registry/sources/animateicons/components/animateicons-check-check/check-check-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Check Check Icon"
      ...
      >
        <CheckCheckIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
