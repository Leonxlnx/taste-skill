...
import { PaperclipIcon } from "@/registry/sources/animateicons/components/animateicons-paperclip/paperclip-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Paperclip Icon"
      ...
      >
        <PaperclipIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
