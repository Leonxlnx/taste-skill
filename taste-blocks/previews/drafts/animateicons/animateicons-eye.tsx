...
import { EyeIcon } from "@/registry/sources/animateicons/components/animateicons-eye/eye-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <EyeIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
