...
import { MicOffIcon } from "@/registry/sources/animateicons/components/animateicons-mic-off/mic-off-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Mic Off Icon"
      ...
      >
        <MicOffIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
