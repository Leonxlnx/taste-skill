...
import { AArrowDownIcon } from "@/registry/sources/animateicons/components/animateicons-a-arrow-down/a-arrow-down-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate A Arrow Down Icon"
      ...
      >
        <AArrowDownIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
