...
import { AtomIcon } from "@/registry/sources/animateicons/components/animateicons-atom/atom-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <AtomIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
