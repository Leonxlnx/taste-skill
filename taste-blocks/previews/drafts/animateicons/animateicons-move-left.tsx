...
import { MoveLeftIcon } from "@/registry/sources/animateicons/components/animateicons-move-left/move-left-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Move Left Icon"
      ...
      >
        <MoveLeftIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
