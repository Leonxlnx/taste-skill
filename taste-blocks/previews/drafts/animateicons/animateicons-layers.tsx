...
import { LayersIcon } from "@/registry/sources/animateicons/components/animateicons-layers/layers-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Layers Icon"
      ...
      >
        <LayersIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
