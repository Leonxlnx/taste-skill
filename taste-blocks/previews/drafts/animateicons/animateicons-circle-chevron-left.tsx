...
import { CircleChevronLeftIcon } from "@/registry/sources/animateicons/components/animateicons-circle-chevron-left/circle-chevron-left-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Circle Chevron Left Icon"
      ...
      >
        <CircleChevronLeftIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
