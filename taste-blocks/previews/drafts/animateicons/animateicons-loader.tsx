...
import { LoaderIcon } from "@/registry/sources/animateicons/components/animateicons-loader/loader-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Loader Icon"
      ...
      >
        <LoaderIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
