...
import { TerminalIcon } from "@/registry/sources/animateicons/components/animateicons-terminal/terminal-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Terminal Icon"
      ...
      >
        <TerminalIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
