...
import { PaperTexture } from '@/registry/sources/paper-shaders/components/paper-shaders/react/shaders/paper-texture';
...
export default function PaperPaperTexturePreview() {
  return (
    <div style={{ width: 'min(100%, 720px)', aspectRatio: '16 / 9', overflow: 'hidden', borderRadius: 24 }}>
      <PaperTexture image={previewImage} role="img" aria-label="Paper Texture shader preview" style={{ width: '100%', height: '100%' }} />
    </div>
  );
}
