...
import { LiquidMetal } from '@/registry/sources/paper-shaders/components/paper-shaders/react/shaders/liquid-metal';
...
export default function PaperLiquidMetalPreview() {
  return (
    <div style={{ width: 'min(100%, 720px)', aspectRatio: '16 / 9', overflow: 'hidden', borderRadius: 24 }}>
      <LiquidMetal image={previewImage} role="img" aria-label="Liquid Metal shader preview" style={{ width: '100%', height: '100%' }} />
    </div>
  );
}
