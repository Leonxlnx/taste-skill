...
import { HalftoneCmyk } from '@/registry/sources/paper-shaders/components/paper-shaders/react/shaders/halftone-cmyk';
...
export default function PaperHalftoneCmykPreview() {
  return (
    <div style={{ width: 'min(100%, 720px)', aspectRatio: '16 / 9', overflow: 'hidden', borderRadius: 24 }}>
      <HalftoneCmyk image={previewImage} role="img" aria-label="Halftone CMYK shader preview" style={{ width: '100%', height: '100%' }} />
    </div>
  );
}
