...
import { LayoutListIcon } from "@/registry/sources/animateicons/components/animateicons-list-panels/layout-list-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate List Panels Icon"
      ...
      >
        <LayoutListIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
