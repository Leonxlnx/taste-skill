...
import { CodeXmlIcon } from "@/registry/sources/animateicons/components/animateicons-code-xml/code-xml-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Code XML Icon"
      ...
      >
        <CodeXmlIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
