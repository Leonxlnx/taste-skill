...
import { ChevronsUpIcon } from "@/registry/sources/animateicons/components/animateicons-chevrons-up/chevrons-up-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chevrons Up Icon"
      ...
      >
        <ChevronsUpIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
