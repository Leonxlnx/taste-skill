...
import { ScanLineIcon } from "@/registry/sources/animateicons/components/animateicons-scan-line/scan-line-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Scan Line Icon"
      ...
      >
        <ScanLineIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
