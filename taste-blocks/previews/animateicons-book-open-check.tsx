...
import { BookOpenCheckIcon } from "@/registry/sources/animateicons/components/animateicons-book-open-check/book-open-check-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Book Open Check Icon"
      ...
      >
        <BookOpenCheckIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
