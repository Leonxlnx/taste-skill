...
import { ScanQrCodeIcon } from "@/registry/sources/animateicons/components/animateicons-scan-qr-code/scan-qr-code-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Scan Qr Code Icon"
      ...
      >
        <ScanQrCodeIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
