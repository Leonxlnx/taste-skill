...
import { CornerDownLeftIcon } from "@/registry/sources/animateicons/components/animateicons-corner-down-left/corner-down-left-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Corner Down Left Icon"
      ...
      >
        <CornerDownLeftIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
