...
import { GitCommitVerticalIcon } from "@/registry/sources/animateicons/components/animateicons-git-commit-vertical/git-commit-vertical-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Git Commit Vertical Icon"
      ...
      >
        <GitCommitVerticalIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
