...
import { ReplyIcon } from "@/registry/sources/animateicons/components/animateicons-reply/reply-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <ReplyIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
