...
import { MoonIcon } from "@/registry/sources/animateicons/components/animateicons-moon/moon-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <MoonIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
