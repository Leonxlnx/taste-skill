...
import { RouteIcon, type RouteIconHandle } from "@/registry/sources/lucide-animated/components/lucide-animated-route-icon/route";

export default function Preview() {
  const icon = useRef<RouteIconHandle>(null);
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <RouteIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
