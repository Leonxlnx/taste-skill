...
import { BadgeDollarIcon } from "@/registry/sources/animateicons/components/animateicons-badge-dollar/badge-dollar-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Badge Dollar Icon"
      ...
      >
        <BadgeDollarIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
