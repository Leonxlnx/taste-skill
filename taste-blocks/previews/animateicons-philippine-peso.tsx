...
import { PhilippinePesoIcon } from "@/registry/sources/animateicons/components/animateicons-philippine-peso/philippine-peso-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Philippine Peso Icon"
      ...
      >
        <PhilippinePesoIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
