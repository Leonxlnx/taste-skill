...
import { MinusIcon } from "@/registry/sources/animateicons/components/animateicons-minus/minus-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <MinusIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
