...
import { CodeIcon } from "@/registry/sources/animateicons/components/animateicons-code/code-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <CodeIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
