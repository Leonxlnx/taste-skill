...
import { MessageCircleIcon } from "@/registry/sources/animateicons/components/animateicons-message-circle/message-circle-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Message Circle Icon"
      ...
      >
        <MessageCircleIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
