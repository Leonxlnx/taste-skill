...
import { ReplyAllIcon } from "@/registry/sources/animateicons/components/animateicons-reply-all/reply-all-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Reply All Icon"
      ...
      >
        <ReplyAllIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
