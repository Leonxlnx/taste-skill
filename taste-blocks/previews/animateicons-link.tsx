...
import { LinkIcon } from "@/registry/sources/animateicons/components/animateicons-link/link-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <LinkIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
