...
import { ClipboardIcon } from "@/registry/sources/animateicons/components/animateicons-clipboard/clipboard-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Clipboard Icon"
      ...
      >
        <ClipboardIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
