...
import { WavesIcon, type WavesIconHandle } from "@/registry/sources/lucide-animated/components/lucide-animated-waves-icon/waves";

export default function Preview() {
  const icon = useRef<WavesIconHandle>(null);
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <WavesIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
