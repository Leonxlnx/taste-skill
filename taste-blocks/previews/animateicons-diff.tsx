...
import { DiffIcon } from "@/registry/sources/animateicons/components/animateicons-diff/diff-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <DiffIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
