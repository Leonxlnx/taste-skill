...
import { ChartLineIcon } from "@/registry/sources/animateicons/components/animateicons-chart-line/chart-line-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chart Line Icon"
      ...
      >
        <ChartLineIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
