...
import { TrendingUpIcon } from "@/registry/sources/animateicons/components/animateicons-trending-up/trending-up-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Trending Up Icon"
      ...
      >
        <TrendingUpIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
