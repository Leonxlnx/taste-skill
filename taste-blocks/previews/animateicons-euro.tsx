...
import { EuroIcon } from "@/registry/sources/animateicons/components/animateicons-euro/euro-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <EuroIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
