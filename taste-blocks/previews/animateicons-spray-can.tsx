...
import { SprayCanIcon } from "@/registry/sources/animateicons/components/animateicons-spray-can/spray-can-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Spray Can Icon"
      ...
      >
        <SprayCanIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
