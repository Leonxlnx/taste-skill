...
import { TurkishLiraIcon } from "@/registry/sources/animateicons/components/animateicons-turkish-lira/turkish-lira-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Turkish Lira Icon"
      ...
      >
        <TurkishLiraIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
