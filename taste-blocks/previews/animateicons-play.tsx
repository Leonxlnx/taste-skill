...
import { PlayIcon } from "@/registry/sources/animateicons/components/animateicons-play/play-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <PlayIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
