...
import { CornerUpLeftIcon } from "@/registry/sources/animateicons/components/animateicons-corner-up-left/corner-up-left-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Corner Up Left Icon"
      ...
      >
        <CornerUpLeftIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
