...
import { FrameIcon, type FrameIconHandle } from "@/registry/sources/lucide-animated/components/lucide-animated-frame-icon/frame";

export default function Preview() {
  const icon = useRef<FrameIconHandle>(null);
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <FrameIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
