...
import { GitCompareArrowsIcon } from "@/registry/sources/animateicons/components/animateicons-git-compare-arrows/git-compare-arrows-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Git Compare Arrows Icon"
      ...
      >
        <GitCompareArrowsIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
