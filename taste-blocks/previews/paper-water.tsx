...
import { Water } from '@/registry/sources/paper-shaders/components/paper-shaders/react/shaders/water';
...
export default function PaperWaterPreview() {
  return (
    <div style={{ width: 'min(100%, 720px)', aspectRatio: '16 / 9', overflow: 'hidden', borderRadius: 24 }}>
      <Water image={previewImage} role="img" aria-label="Water shader preview" style={{ width: '100%', height: '100%' }} />
    </div>
  );
}
