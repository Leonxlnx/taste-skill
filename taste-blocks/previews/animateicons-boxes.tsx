...
import { BoxesIcon } from "@/registry/sources/animateicons/components/animateicons-boxes/boxes-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <BoxesIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
