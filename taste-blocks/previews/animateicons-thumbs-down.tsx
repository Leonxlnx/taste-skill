...
import { ThumbsDownIcon } from "@/registry/sources/animateicons/components/animateicons-thumbs-down/thumbs-down-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Thumbs Down Icon"
      ...
      >
        <ThumbsDownIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
