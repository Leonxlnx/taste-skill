...
import { ChartPieIcon } from "@/registry/sources/animateicons/components/animateicons-chart-pie/chart-pie-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chart Pie Icon"
      ...
      >
        <ChartPieIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
