...
import { PlusIcon } from "@/registry/sources/animateicons/components/animateicons-plus/plus-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <PlusIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
