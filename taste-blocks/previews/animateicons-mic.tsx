...
import { MicIcon } from "@/registry/sources/animateicons/components/animateicons-mic/mic-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <MicIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
