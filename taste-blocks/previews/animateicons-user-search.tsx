...
import { UserSearchIcon } from "@/registry/sources/animateicons/components/animateicons-user-search/user-search-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate User Search Icon"
      ...
      >
        <UserSearchIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
