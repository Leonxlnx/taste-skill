...
import { GitCommitHorizontalIcon } from "@/registry/sources/animateicons/components/animateicons-git-commit-horizontal/git-commit-horizontal-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Git Commit Horizontal Icon"
      ...
      >
        <GitCommitHorizontalIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
