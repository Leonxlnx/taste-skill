...
import { UsersIcon } from "@/registry/sources/animateicons/components/animateicons-users/users-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <UsersIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
