...
import { SquareArrowOutUpRightIcon } from "@/registry/sources/animateicons/components/animateicons-square-arrow-out-up-right/square-arrow-out-up-right-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Square Arrow Out Up Right Icon"
      ...
      >
        <SquareArrowOutUpRightIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
