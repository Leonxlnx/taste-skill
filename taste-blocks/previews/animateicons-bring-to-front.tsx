...
import { BringToFrontIcon } from "@/registry/sources/animateicons/components/animateicons-bring-to-front/bring-to-front-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Bring To Front Icon"
      ...
      >
        <BringToFrontIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
