...
import { MapPinnedIcon } from "@/registry/sources/animateicons/components/animateicons-map-pinned/map-pinned-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Map Pinned Icon"
      ...
      >
        <MapPinnedIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
