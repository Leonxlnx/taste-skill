...
import { KeyIcon } from "@/registry/sources/animateicons/components/animateicons-key/key-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <KeyIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
