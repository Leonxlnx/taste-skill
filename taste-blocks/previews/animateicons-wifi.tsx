...
import { WifiIcon } from "@/registry/sources/animateicons/components/animateicons-wifi/wifi-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <WifiIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
