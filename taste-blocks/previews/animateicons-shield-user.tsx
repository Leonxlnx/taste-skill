...
import { ShieldUserIcon } from "@/registry/sources/animateicons/components/animateicons-shield-user/shield-user-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Shield User Icon"
      ...
      >
        <ShieldUserIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
