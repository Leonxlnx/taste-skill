...
import { CreditCardIcon } from "@/registry/sources/animateicons/components/animateicons-credit-card/credit-card-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Credit Card Icon"
      ...
      >
        <CreditCardIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
