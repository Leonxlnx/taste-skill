...
import { MailIcon } from "@/registry/sources/animateicons/components/animateicons-mail/mail-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <MailIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
