...
import { LayoutGridIcon } from "@/registry/sources/animateicons/components/animateicons-grid-panels/layout-grid-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Grid Panels Icon"
      ...
      >
        <LayoutGridIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
