...
import { CheckIcon } from "@/registry/sources/animateicons/components/animateicons-check/check-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <CheckIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
