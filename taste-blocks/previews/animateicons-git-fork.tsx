...
import { GitForkIcon } from "@/registry/sources/animateicons/components/animateicons-git-fork/git-fork-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Git Fork Icon"
      ...
      >
        <GitForkIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
