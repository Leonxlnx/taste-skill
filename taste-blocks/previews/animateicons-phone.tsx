...
import { PhoneIcon } from "@/registry/sources/animateicons/components/animateicons-phone/phone-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <PhoneIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
