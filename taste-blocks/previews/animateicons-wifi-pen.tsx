...
import { WifiPenIcon } from "@/registry/sources/animateicons/components/animateicons-wifi-pen/wifi-pen-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Wifi Pen Icon"
      ...
      >
        <WifiPenIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
