...
import { SnowFlakeIcon } from "@/registry/sources/animateicons/components/animateicons-snow-flake/snow-flake-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Snow Flake Icon"
      ...
      >
        <SnowFlakeIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
