...
import { SettingsIcon } from "@/registry/sources/animateicons/components/animateicons-settings/settings-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Settings Icon"
      ...
      >
        <SettingsIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
