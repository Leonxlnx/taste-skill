...
import { ArrowUp01Icon } from "@/registry/sources/animateicons/components/animateicons-arrow-up-0-1/arrow-up-0-1-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Arrow Up 0 1 Icon"
      ...
      >
        <ArrowUp01Icon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
