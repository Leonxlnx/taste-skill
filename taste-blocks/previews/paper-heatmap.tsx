...
import { Heatmap } from '@/registry/sources/paper-shaders/components/paper-shaders/react/shaders/heatmap';
...
export default function PaperHeatmapPreview() {
  return (
    <div style={{ width: 'min(100%, 720px)', aspectRatio: '16 / 9', overflow: 'hidden', borderRadius: 24 }}>
      <Heatmap image={previewImage} role="img" aria-label="Heatmap shader preview" style={{ width: '100%', height: '100%' }} />
    </div>
  );
}
