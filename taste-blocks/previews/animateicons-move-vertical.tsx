...
import { MoveVerticalIcon } from "@/registry/sources/animateicons/components/animateicons-move-vertical/move-vertical-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Move Vertical Icon"
      ...
      >
        <MoveVerticalIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
