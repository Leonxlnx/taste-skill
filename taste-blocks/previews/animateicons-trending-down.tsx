...
import { TrendingDownIcon } from "@/registry/sources/animateicons/components/animateicons-trending-down/trending-down-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Trending Down Icon"
      ...
      >
        <TrendingDownIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
