...
import { UserStarIcon } from "@/registry/sources/animateicons/components/animateicons-user-star/user-star-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate User Star Icon"
      ...
      >
        <UserStarIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
