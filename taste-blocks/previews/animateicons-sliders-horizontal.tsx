...
import { SlidersHorizontalIcon } from "@/registry/sources/animateicons/components/animateicons-sliders-horizontal/sliders-horizontal-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Sliders Horizontal Icon"
      ...
      >
        <SlidersHorizontalIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
