...
import { BicepsFlexedIcon } from "@/registry/sources/animateicons/components/animateicons-biceps-flexed/biceps-flexed-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Biceps Flexed Icon"
      ...
      >
        <BicepsFlexedIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
