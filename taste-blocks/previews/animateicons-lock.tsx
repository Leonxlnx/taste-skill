...
import { LockIcon } from "@/registry/sources/animateicons/components/animateicons-lock/lock-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <LockIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
