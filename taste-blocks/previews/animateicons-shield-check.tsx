...
import { ShieldCheckIcon } from "@/registry/sources/animateicons/components/animateicons-shield-check/shield-check-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Shield Check Icon"
      ...
      >
        <ShieldCheckIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
