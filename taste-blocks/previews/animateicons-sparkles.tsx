...
import { SparklesIcon } from "@/registry/sources/animateicons/components/animateicons-sparkles/sparkles-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Sparkles Icon"
      ...
      >
        <SparklesIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
