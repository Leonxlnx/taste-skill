...
import { EllipsisIcon } from "@/registry/sources/animateicons/components/animateicons-ellipsis/ellipsis-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Ellipsis Icon"
      ...
      >
        <EllipsisIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
