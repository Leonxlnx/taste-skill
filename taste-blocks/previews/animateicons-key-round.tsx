...
import { KeyRoundIcon } from "@/registry/sources/animateicons/components/animateicons-key-round/key-round-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Key Round Icon"
      ...
      >
        <KeyRoundIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
