...
import { BaggageClaimIcon } from "@/registry/sources/animateicons/components/animateicons-baggage-claim/baggage-claim-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Baggage Claim Icon"
      ...
      >
        <BaggageClaimIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
