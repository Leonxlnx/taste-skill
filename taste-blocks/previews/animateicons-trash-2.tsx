...
import { Trash2Icon } from "@/registry/sources/animateicons/components/animateicons-trash-2/trash-2-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Trash 2 Icon"
      ...
      >
        <Trash2Icon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
