...
import { MousePointerClickIcon } from "@/registry/sources/animateicons/components/animateicons-mouse-pointer-click/mouse-pointer-click-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Mouse Pointer Click Icon"
      ...
      >
        <MousePointerClickIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
