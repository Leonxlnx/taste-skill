...
import { SearchIcon } from "@/registry/sources/animateicons/components/animateicons-search/search-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Search Icon"
      ...
      >
        <SearchIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
