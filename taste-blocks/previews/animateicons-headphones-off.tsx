...
import { HeadphonesOffIcon } from "@/registry/sources/animateicons/components/animateicons-headphones-off/headphones-off-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Headphones Off Icon"
      ...
      >
        <HeadphonesOffIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
