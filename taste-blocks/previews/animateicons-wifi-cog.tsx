...
import { WifiCogIcon } from "@/registry/sources/animateicons/components/animateicons-wifi-cog/wifi-cog-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Wifi Cog Icon"
      ...
      >
        <WifiCogIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
