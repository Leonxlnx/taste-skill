...
import { HeadsetIcon } from "@/registry/sources/animateicons/components/animateicons-headset/headset-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Headset Icon"
      ...
      >
        <HeadsetIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
