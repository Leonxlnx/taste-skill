...
import { UserCogIcon } from "@/registry/sources/animateicons/components/animateicons-user-cog/user-cog-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate User Cog Icon"
      ...
      >
        <UserCogIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
