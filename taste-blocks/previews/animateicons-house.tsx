...
import { HouseIcon } from "@/registry/sources/animateicons/components/animateicons-house/house-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <HouseIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
