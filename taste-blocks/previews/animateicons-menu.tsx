...
import { MenuIcon } from "@/registry/sources/animateicons/components/animateicons-menu/menu-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <MenuIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
