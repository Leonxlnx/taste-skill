...
import { ArrowDownUpIcon } from "@/registry/sources/animateicons/components/animateicons-arrow-down-up/arrow-down-up-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Arrow Down Up Icon"
      ...
      >
        <ArrowDownUpIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
