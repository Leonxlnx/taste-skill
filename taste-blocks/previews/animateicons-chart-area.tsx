...
import { ChartAreaIcon } from "@/registry/sources/animateicons/components/animateicons-chart-area/chart-area-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chart Area Icon"
      ...
      >
        <ChartAreaIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
