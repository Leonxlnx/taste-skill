...
import { CornerRightUpIcon } from "@/registry/sources/animateicons/components/animateicons-corner-right-up/corner-right-up-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Corner Right Up Icon"
      ...
      >
        <CornerRightUpIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
