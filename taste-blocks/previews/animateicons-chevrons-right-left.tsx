...
import { ChevronsRightLeftIcon } from "@/registry/sources/animateicons/components/animateicons-chevrons-right-left/chevrons-right-left-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Chevrons Right Left Icon"
      ...
      >
        <ChevronsRightLeftIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
