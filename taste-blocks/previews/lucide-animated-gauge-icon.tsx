...
import { GaugeIcon, type GaugeIconHandle } from "@/registry/sources/lucide-animated/components/lucide-animated-gauge-icon/gauge";

export default function Preview() {
  const icon = useRef<GaugeIconHandle>(null);
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <GaugeIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
