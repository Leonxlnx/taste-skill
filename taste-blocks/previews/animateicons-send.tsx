...
import { SendIcon } from "@/registry/sources/animateicons/components/animateicons-send/send-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <SendIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
