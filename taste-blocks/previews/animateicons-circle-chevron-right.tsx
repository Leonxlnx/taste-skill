...
import { CircleChevronRightIcon } from "@/registry/sources/animateicons/components/animateicons-circle-chevron-right/circle-chevron-right-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Circle Chevron Right Icon"
      ...
      >
        <CircleChevronRightIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
