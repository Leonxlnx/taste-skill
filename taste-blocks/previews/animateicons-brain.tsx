...
import { BrainIcon } from "@/registry/sources/animateicons/components/animateicons-brain/brain-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <BrainIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
