...
import { BikeIcon } from "@/registry/sources/animateicons/components/animateicons-bike/bike-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <BikeIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
