...
import { ArrowUpAZIcon } from "@/registry/sources/animateicons/components/animateicons-arrow-up-a-z/arrow-up-a-z-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Arrow Up A Z Icon"
      ...
      >
        <ArrowUpAZIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
