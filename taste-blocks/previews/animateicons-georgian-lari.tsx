...
import { GeorgianLariIcon } from "@/registry/sources/animateicons/components/animateicons-georgian-lari/georgian-lari-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Georgian Lari Icon"
      ...
      >
        <GeorgianLariIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
