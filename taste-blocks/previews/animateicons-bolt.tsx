...
import { BoltIcon } from "@/registry/sources/animateicons/components/animateicons-bolt/bolt-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <BoltIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
