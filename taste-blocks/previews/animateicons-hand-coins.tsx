...
import { HandCoinsIcon } from "@/registry/sources/animateicons/components/animateicons-hand-coins/hand-coins-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Hand Coins Icon"
      ...
      >
        <HandCoinsIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
