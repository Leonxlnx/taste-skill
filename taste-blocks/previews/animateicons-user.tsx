...
import { UserIcon } from "@/registry/sources/animateicons/components/animateicons-user/user-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <UserIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
