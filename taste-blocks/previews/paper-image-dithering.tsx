...
import { ImageDithering } from '@/registry/sources/paper-shaders/components/paper-shaders/react/shaders/image-dithering';
...
export default function PaperImageDitheringPreview() {
  return (
    <div style={{ width: 'min(100%, 720px)', aspectRatio: '16 / 9', overflow: 'hidden', borderRadius: 24 }}>
      <ImageDithering image={previewImage} role="img" aria-label="Image Dithering shader preview" style={{ width: '100%', height: '100%' }} />
    </div>
  );
}
