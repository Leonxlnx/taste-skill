...
import { UserCheckIcon } from "@/registry/sources/animateicons/components/animateicons-user-check/user-check-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate User Check Icon"
      ...
      >
        <UserCheckIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
