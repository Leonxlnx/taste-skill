...
import { ActivityIcon } from "@/registry/sources/animateicons/components/animateicons-activity/activity-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      <button
        type="button"
        aria-label="Animate Activity Icon"
      ...
      >
        <ActivityIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
