...
import { MailsIcon } from "@/registry/sources/animateicons/components/animateicons-mails/mails-icon";
...
export default function Preview() {
  ...
  return (
    <div className="flex min-h-72 items-center justify-center">
      ...
      >
        <MailsIcon ref={icon} aria-hidden="true" size={64} />
      </button>
    </div>
  );
}
