...
export interface HashtagIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface HashtagIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
  isAnimated?: boolean;
}
...
const HashtagIcon = forwardRef<HashtagIconHandle, HashtagIconProps>(
