...
export const ContributionGraph = ({
  ...
  const maxLevel = Math.min(4, Math.max(1, maxLevelProp));
...
export const ContributionGraphBlock = ({
  ...
  return (
    <rect
      aria-label={ariaLabel ?? `${activity.date}: ${activity.count} activities`}
      className={cn(
...
export const ContributionGraphLegend = ({
  ...
  return (
    <div
      className={cn("ms-auto flex items-center gap-[3px]", className)}
      {...props}
    >
