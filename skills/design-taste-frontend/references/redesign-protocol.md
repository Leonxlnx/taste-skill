# Redesign Protocol - Audit, Preserve, Modernise

Referenced from `SKILL.md` Section 11. Read this file whenever the mode detected
in 11.A is **Preserve** or **Overhaul** - i.e. any time you are touching an
interface that already exists and already has users.

Greenfield work does not need this file.
