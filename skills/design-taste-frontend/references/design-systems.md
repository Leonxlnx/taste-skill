# Design Systems - Install Commands and Canonical Sources

Referenced from `SKILL.md` Sections 2.A and 14. Load this when the brief maps
onto a real design system and you need the exact package names or the official
docs. Real install commands, real canonical doc links - use them instead of
recalling package names from training data.
